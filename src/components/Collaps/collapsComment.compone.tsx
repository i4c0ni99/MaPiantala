...
export const CommentCollaps: React.FC<ICollapsComment> = function ({
    ...
    return (
        ...
        <div className="card size-full bg-base-200 mt-4 mb-4 ">
            <details className="collapse bg-base-200">
                <summary className="collapse-title text-xl font-medium">{terrain.title}</summary>
                <div className="collapse-content">
                    <p>{terrain.description}</p>
                </div>
            </details>
            <div className="collapse max-w-screen bg-base-200">
                <input type="checkbox" />
                ...
                <div className="collapse-content  ">
                    ...
                    <div className="flex flex-row pt-4 pb-2">
                        <textarea
                            className="textarea textarea-accent h-4 basis-3/4"
                            placeholder="Bio"
                        ></textarea>
                        <button className=" ml-2 mr-2  btn btn-active btn-accent basis-1/4">
                            Send
                        </button>
                    </div>
                </div>
