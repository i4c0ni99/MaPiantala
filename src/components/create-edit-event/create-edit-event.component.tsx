...
export const CreateEditEvent = ({
    ...
    const [event, setEvent] = useState<Event>(
        new Event(
            eventCreated.id,
            eventCreated.partecipantsNumer,
            eventCreated.title,
            eventCreated.description,
            eventCreated.imageUrl,
            eventCreated.scheduledDate,
            eventCreated.owner,
            eventCreated.comments,
            eventCreated.address,
            eventCreated.isPublic,
            eventCreated.latitude,
            eventCreated.longitude,
            eventCreated.category,
            eventCreated.createdAt,
            eventCreated.updatedAt
        )
    );
                ...
                <form className="w-full" onSubmit={handleSubmit}>
                    <div className="card-body mt-12">
                        ...
                        <label className="form-control w-full max-w-xs">
                            <div className="label">
                                <span className="label-text">
                                    Scgli un immagine dal web per il tuo evento
                                </span>
                            </div>
                            <input
                                name="imageUrl"
