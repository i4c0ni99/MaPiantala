...
export const TerrainDetailAdminCard: React.FC<ICardTErrainDetailAdmin> =
    function ({ terrain, onSubmission }) {
        ...
        const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
            ...
            if (terrain) {
                ...
                if (onSubmission) onSubmission(terrain);
            }
            ...
            return (
                <div className="card lg:card-side bg-base-300 shadow-xl">
                    <figure className="h-72 w-64 lg:size-96 mt-8 mx-6">
                        <MapCard obj={terrain as Terrain}></MapCard>
                    </figure>
                            ...
                            <label className="form-control w-full max-w-xs">
                                <div className="label w-64">
                                    <span className=" font-bold">
                                        Terreno di {terrain.terrainSize} m² da
                                        dividere in slot
                                    </span>
                                </div>
                                <select
