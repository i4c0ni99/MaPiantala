...
export const Profile: React.FC<IHeroProfile> = function ({
    ...
    return (
        <div className="hero size-full" style={{ backgroundImage: user.copertinePicture ? "url(" + user.copertinePicture + ")": "url("+ "https://upload.wikimedia.org/wikipedia/commons/9/97/Campo_Felice_Lake.jpg"+")" }}>
