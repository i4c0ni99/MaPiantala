...
export const CardSettings: React.FC<IHeroSettings> = function ({
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (userModified.password != null && userModified.password.length < 6) {
  ...
  const handleChange = (
    ...
    console.log(userModified.copertinePicture, userModified.profilePicture);
  };
                ...
                <form onSubmit={handleSubmit}>
                  <div className="form-control">
                    ...
                    <input
                      ...
                      placeholder="Nome"
                      name="firstName"
                      defaultValue={userModified.firstName}
                  ...
                  <div className="form-control">
                    ...
                    <input
                      ...
                      placeholder="Cognome"
                      name="lastName"
                      defaultValue={userModified.lastName}
                      className="input input-bordered"
                      onChange={handleChange}
                      required
                    />
                  ...
                  <div className="form-control">
                    ...
                    <input
                      ...
                      placeholder="Email"
                      name="email"
                      defaultValue={userModified.email}
                      className="input input-bordered"
                      onChange={handleChange}
                      required
                    />
                  ...
                  <div className="form-control">
                    ...
                    <input
                      ...
                      name="profilePicture"
                      defaultValue={userModified.profilePicture}
                      className="input input-bordered"
                      onChange={handleChange}
                    />
                  </div>
                  ...
                  <div className="form-control">
                    ...
                    <input
                      ...
                      defaultValue={userModified.copertinePicture}
                      className="input input-bordered"
                      onChange={handleChange}
                    />
                  </div>
                  ...
                  <div className="form-control">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="password"
                        defaultValue={userModified.password}
